...
class Arff:
    ...
    def __init__(self, arff=None, row_idx=None, col_idx=None, label_count=None, name="Untitled", numeric=True,
                 missing=float("NaN")):
        """
        Args:
    ...
    def _copy_and_slice_arff(self, arff=None, row_idx=None, col_idx=None, label_count=None, dataset_name="Untitled"):
        ...
        if label_count is None and arff.label_count:
            label_list = [1 if i in range(column_count - arff.label_count, column_count) else 0 for i in
                          range(column_count)]
    ...
    def get_labels(self, row_idx=None):
        ...
        new_arff = self.create_subset_arff(row_idx=row_idx, col_idx=slice(start_idx, None),
